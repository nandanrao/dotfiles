...
globalkeys = gears.table.join(
    ...
    -- Sound
     ...
     awful.key({ }, "XF86Explorer", function () awful.util.spawn("scrot -s") end)
)
...
navkeys = gears.table.join(
   awful.key({ "Control" }, "a",
       function () 
          ...
          {description="ctrl-a to Home", group="nandan"}),
   awful.key({ "Control" }, "e",
       function () 
          ...
          {description="ctrl-e to End", group="nandan"})
)
